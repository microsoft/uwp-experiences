...
namespace Controls
{
    public class TimelinePanel : Panel
    {
        ...
        public static readonly DependencyProperty IsLockedProperty =
            DependencyProperty.Register("IsLocked", typeof(bool), typeof(TimelinePanel), new PropertyMetadata(false));
        ...
        public int ItemIndex
        {
            ...
            set
            {
                ...
                if (value != ItemIndex)
                {
                    ItemIndexChanged?.Invoke(this, new TimelinePanelItemIndexEventArgs() { OldValue = ItemIndex, NewValue = value });
        ...
        public static readonly DependencyProperty ItemSpacingProperty =
            DependencyProperty.Register("ItemSpacing", typeof(double), typeof(TimelinePanel), new PropertyMetadata(80d, OnPropertyChanged));
