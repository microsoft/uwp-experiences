...
{
    public class AdventureObjectStorageHelper : IObjectStorageHelper
    {
        ...
        public static async Task<StorageFolder> GetDataSaveFolder()
        {
            ...
            try
            {
                ...
                try
                {
                    folder = await pictureLibraryFolder.GetFolderAsync("adventure_photos");
                }
                catch (Exception ex)
                {
                    folder = await pictureLibraryFolder.CreateFolderAsync("adventure_photos");
                }
            }
            catch (Exception ex)
            {
