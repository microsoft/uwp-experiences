...
namespace Controls
{
    ...
    public sealed class Timeline : ContentControl
    {
        ...
        public static readonly DependencyProperty CurrentItemIndexProperty =
            DependencyProperty.Register("CurrentItemIndex", typeof(int), typeof(Timeline), new PropertyMetadata(0, OnItemIndexChanged));
        ...
        private static void OnItemIndexChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            timeline.TimelinePanel.ItemIndex = (int)e.NewValue;
        }
